...
I am a third year Ph.D. student in the Graduate School of AI at [Seoul National University][1], advised by [Prof. Byoung-Tak Zhang][3]. My research straddles machine learning, natural language processing, computer vision, and robotics. My current focus is modeling <span class="fw-550">machine learning algorithms that learn non-linguistic experiences in the physical world (e.g., sensory perception and action) with natural language</span>. The long-term goal of my research is to build machines that can
